...
namespace CgmLink.Nutrition.Data.Repository;

[ExcludeFromCodeCoverage] // Maybe one day but EF is a bit of a pain...
public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
{
    private readonly CgmLinkNutritionDbContext _glucoPilotNutritionDbContext;

    public Repository(CgmLinkNutritionDbContext glucoPilotNutritionDbContext)
    {
