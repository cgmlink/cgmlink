...
namespace CgmLink.Data.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20260916143618_RequireIngredientServingOnMealIngredients")]
    partial class RequireIngredientServingOnMealIngredients
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.AlarmRule", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.Insulin", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.Reading", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.Sensor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.TreatmentIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.AlarmRule", b =>
                {
                    b.HasOne("CgmLink.Data.Entities.Patient", "Patient")
                        .WithMany("AlarmRules")
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.Injection", b =>
                {
                    b.HasOne("CgmLink.Data.Entities.Insulin", "Insulin")
                        .WithMany()
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.Treatment", b =>
                {
                    b.HasOne("CgmLink.Data.Entities.Injection", "Injection")
                        .WithMany()
                        .HasForeignKey("InjectionId");

                    b.HasOne("CgmLink.Data.Entities.Reading", "Reading")
                        .WithMany()
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.User", b =>
                {
                    b.OwnsMany("CgmLink.Data.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("CgmLink.Data.Entities.UserSettings", "Settings", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("DailyCalorieTarget")
                                .HasColumnType("int");

                            b1.Property<int>("DailyCarbTarget")
                                .HasColumnType("int");

                            b1.Property<int>("DailyFatTarget")
                                .HasColumnType("int");

                            b1.Property<int>("DailyProteinTarget")
                                .HasColumnType("int");

                            b1.Property<int>("GlucoseUnitOfMeasurement")
                                .HasColumnType("int");

                            b1.Property<double>("HighSugarThreshold")
                                .HasColumnType("float");

                            b1.Property<double>("LowSugarThreshold")
                                .HasColumnType("float");

                            b1.Property<bool>("UseLinearIob")
                                .HasColumnType("bit");
            ...
            modelBuilder.Entity("CgmLink.Data.Entities.Patient", b =>
                {
                    ...
                    b.OwnsOne("CgmLink.Data.Entities.AuthTicket", "AuthTicket", b1 =>
                        {
                            b1.Property<Guid>("PatientId1")
                                .HasColumnType("uniqueidentifier");
