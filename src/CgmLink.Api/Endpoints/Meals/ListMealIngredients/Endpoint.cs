...
{
    internal static async Task<Results<Ok<ListMealIngredientsResponse>, NotFound, UnauthorizedHttpResult>> HandleAsync(
        [FromRoute] Guid id,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return TypedResults.Ok(ListMealIngredientsResponse.ToResponse(meal));
    }
}