...
using CgmLink.LibreLinkClient.Models;
using Microsoft.AspNetCore.Http.HttpResults;
using Moq;
using NUnit.Framework;
using AuthTicket = CgmLink.Data.Entities.AuthTicket;

namespace CgmLink.Api.Tests.Endpoints.LibreLink;
    ...
    public async Task HandleAsync_Should_Use_Correct_Regioned_Client([Values] Region region)
    {
        ...
        _patientRepositoryMock
            .Setup(r => r.FindOneAsync(It.IsAny<Expression<Func<Patient, bool>>>(), It.IsAny<FindOptions>(),
                It.IsAny<CancellationToken>()))
            .ReturnsAsync(patient);
        _libreLinkClientMock.Setup(x => x.LoginAsync(It.IsAny<CgmLink.LibreLinkClient.Models.AuthTicket>(), It.IsAny<CancellationToken>()))
