...
using CgmLink.Api.Endpoints.Injections.NewInjection;
...
public class NewInjectionTests
{
    ...
    public void HandleAsync_Should_Return_Unauthorized_When_User_Is_Not_Authenticated()
    {
        ...
        Assert.That(() => Endpoint.HandleAsync(request, _validatorMock.Object, _currentUserMock.Object, _injectionsRepositoryMock.Object, _insulinRepositoryMock.Object, CancellationToken.None),
